...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeOrder(View view) {
        ...
        // si el numero de productos es 0 no podemos continuar
        if(numberOfProducts == 0){
            Toast.makeText(this, R.string.toastPreOrder0, Toast.LENGTH_SHORT).show();
        }else if(nombre.getText().toString().equals("")  || e_mail.getText().toString().equals("")){
            Toast.makeText(this, R.string.toastPreOrder1, Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    public void countDown(View view) {
        //solo restará cafes si el numero es mayor a 0
        if (numberOfProducts > 0) {
            --numberOfProducts;
            if (mShowCount != null) {
                mShowCount.setText(Integer.toString(numberOfProducts));
